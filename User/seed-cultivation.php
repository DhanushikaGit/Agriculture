...
// Fetch all records from the seed_cultivation table
$sql = "SELECT * FROM seed_cultivation ORDER BY id DESC";
$result = $conn->query($sql);

if (!$result) {
    die("Error fetching cultivation records: " . $conn->error);
}
?>
...
<body class="bg-gray-100">
    ...
    <div class="container mx-auto mt-10 p-6 bg-white shadow-lg rounded-lg">
        <h1 class="text-3xl font-bold text-center mb-6">Seed Cultivation</h1>
        ...
        <?php else: ?>
            <p class="text-center text-gray-500">No cultivation records found.</p>
        <?php endif; ?>
    </div>
