...
<head>
  ...
  <meta name="description" content="Water Application Form">
  <meta name="keywords" content="water, agriculture, farming">
  ...
  <main class="main">
    ...
    <div class="page-title dark-background" data-aos="fade" style="background-image: url(assets/img/page-title-bg.webp);">
      <div class="container position-relative">
        <h1>Water Application</h1>
        <p>Apply for water supply and ensure your crops get the necessary irrigation.</p>
        <nav class="breadcrumbs">
          <ol>
            <li><a href="index.html">Home</a></li>
            <li class="current">Water</li>
          </ol>
        </nav>
      </div>
    </div><!-- End Page Title -->
    ...
    <!-- Water Form Section -->
    <section id="water-form" class="water-form section">

      <div class="container">
        <div class="row gy-4 justify-content-center">
          <div class="col-lg-8" data-aos="fade-up" data-aos-delay="100">
            <h2 class="content-title mb-4">Water Application Form</h2>
            <form action="submit_water.php" method="post" class="php-email-form">
              <div class="row">
