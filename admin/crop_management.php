...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["add"])) {
        ...
        $sql = "INSERT INTO crop_management (title, description, category)
...
<head>
    ...
    <title>Admin Panel - Crop Management</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Admin Panel - Crop Management</h1>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                <select name="category" required>
                    <option value="Growth Stage Monitoring">Growth Stage Monitoring</option>
