...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_POST["add"])) {
        ...
        $sql = "INSERT INTO agricultural_technology (title, description, category)
    ...
    if (isset($_POST["edit"])) {
        ...
        $sql = "UPDATE agricultural_technology
    ...
    if (isset($_POST["delete"])) {
        ...
        $sql = "DELETE FROM agricultural_technology WHERE id=$id";
        if ($conn->query($sql)) {
...
$sql = "SELECT * FROM agricultural_technology";
...
<head>
    ...
    <title>Admin Panel - Agricultural Technology</title>
    <style>
        body {
...
<body>
    <div class="container">
        <h1>Admin Panel - Agricultural Technology</h1>
        ...
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                <select name="category" required>
                    <option value="Modern Equipment Usage">Modern Equipment Usage</option>
                    <option value="Smart Irrigation Systems">Smart Irrigation Systems</option>
                    <option value="Data-Driven Farming">Data-Driven Farming</option>
